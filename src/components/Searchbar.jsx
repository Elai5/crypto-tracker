    ...
    <div className="relative font-primary">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-3 rounded-lg border text-white bg-gray-800 border-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
        />
        {searchTerm && (
          <button
            onClick={clearSearch}
